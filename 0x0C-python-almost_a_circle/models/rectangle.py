#!/usr/bin/python3
"""represents rectangle and inherits from the Base class"""
...
class Rectangle(Base):
    ...
    def to_dictionary(self):
        """return a dictionary representation of the rec"""
        return {
            "id": self.id,
            "width": self.width,
            "height": self.height,
    ...
    def __str__(self):
        """return a human-readable representation of the rec"""
